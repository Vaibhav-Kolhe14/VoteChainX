...
>>>>>>> 1969b55efe8627e4b8234fb18c68511e7d13bbaf
      ...
      <div className="max-w-4xl mx-auto px-4 mt-8 ">
        ...
        <ol className="space-y-3">
          ...
          <li className="bg-gray-800 p-4 rounded shadow-lg"><strong>Step 2:</strong> Buy VKTokens from the <button onClick={() => navigateTo("/token-marketplace")} className="text-blue-400">Token Marketplace</button> if you don't have any.</li>
          <li className="bg-gray-800 p-4 rounded shadow-lg"><strong>Step 3:</strong> Participate in voting only if you hold VKTokens.</li>
